...
export const car = $root.car = (() => {
    ...
    car.v1 = (function() {
         ...
         * @enum {number}
         * @property {number} CS_NOT_SPECIFID=0 CS_NOT_SPECIFID value
        ...
        v1.CarStatus = (function() {
            ...
            values[valuesById[0] = "CS_NOT_SPECIFID"] = 0;
        ...
        v1.Car = (function() {
            ...
            Car.toObject = function toObject(message, options) {
                ...
                let object = {};
                if (options.defaults) {
                    object.status = options.enums === String ? "CS_NOT_SPECIFID" : 0;
                    object.driver = null;
        ...
        v1.UpdataCarRequest = (function() {

            /**
             * Properties of an UpdataCarRequest.
             * @memberof car.v1
             * @interface IUpdataCarRequest
             * @property {string|null} [id] UpdataCarRequest id
             * @property {car.v1.CarStatus|null} [status] UpdataCarRequest status
             * @property {car.v1.ILocation|null} [position] UpdataCarRequest position
             */

            /**
             * Constructs a new UpdataCarRequest.
             * @memberof car.v1
             * @classdesc Represents an UpdataCarRequest.
             * @implements IUpdataCarRequest
             * @constructor
             * @param {car.v1.IUpdataCarRequest=} [properties] Properties to set
             */
            function UpdataCarRequest(properties) {
                if (properties)
                    for (let keys = Object.keys(properties), i = 0; i < keys.length; ++i)
                        if (properties[keys[i]] != null)
                            this[keys[i]] = properties[keys[i]];
             ...
             * UpdataCarRequest id.
             * @member {string} id
             * @memberof car.v1.UpdataCarRequest
             * @instance
             */
            UpdataCarRequest.prototype.id = "";

            /**
             * UpdataCarRequest status.
             * @member {car.v1.CarStatus} status
             * @memberof car.v1.UpdataCarRequest
             * @instance
             */
            UpdataCarRequest.prototype.status = 0;

            /**
             * UpdataCarRequest position.
             * @member {car.v1.ILocation|null|undefined} position
             * @memberof car.v1.UpdataCarRequest
             * @instance
             */
            UpdataCarRequest.prototype.position = null;

            /**
             * Creates an UpdataCarRequest message from a plain object. Also converts values to their respective internal types.
             * @function fromObject
             * @memberof car.v1.UpdataCarRequest
             * @static
             * @param {Object.<string,*>} object Plain object
             * @returns {car.v1.UpdataCarRequest} UpdataCarRequest
             */
            UpdataCarRequest.fromObject = function fromObject(object) {
                if (object instanceof $root.car.v1.UpdataCarRequest)
                    return object;
                let message = new $root.car.v1.UpdataCarRequest();
                if (object.id != null)
                    message.id = String(object.id);
                switch (object.status) {
                case "CS_NOT_SPECIFID":
                ...
                if (object.position != null) {
                    if (typeof object.position !== "object")
                        throw TypeError(".car.v1.UpdataCarRequest.position: object expected");
                    message.position = $root.car.v1.Location.fromObject(object.position);
                }
                return message;
            };
            ...
            /**
             * Creates a plain object from an UpdataCarRequest message. Also converts values to other types if specified.
             * @function toObject
             * @memberof car.v1.UpdataCarRequest
             * @static
             * @param {car.v1.UpdataCarRequest} message UpdataCarRequest
             * @param {$protobuf.IConversionOptions} [options] Conversion options
             * @returns {Object.<string,*>} Plain object
             */
            UpdataCarRequest.toObject = function toObject(message, options) {
                if (!options)
                    options = {};
                let object = {};
                if (options.defaults) {
            ...
            /**
             * Converts this UpdataCarRequest to JSON.
             * @function toJSON
             * @memberof car.v1.UpdataCarRequest
             * @instance
             * @returns {Object.<string,*>} JSON object
             */
            UpdataCarRequest.prototype.toJSON = function toJSON() {
                return this.constructor.toObject(this, $protobuf.util.toJSONOptions);
            };

            return UpdataCarRequest;
        })();
        ...
        v1.CarService = (function() {
            ...
            /**
             * Callback as used by {@link car.v1.CarService#updataCar}.
             * @memberof car.v1.CarService
             * @typedef UpdataCarCallback
             * @type {function}
             * @param {Error|null} error Error, if any
             * @param {car.v1.Car} [response] Car
             */
             ...
             * @memberof car.v1.CarService
             * @instance
             * @param {car.v1.IUpdataCarRequest} request UpdataCarRequest message or plain object
             * @param {car.v1.CarService.UpdataCarCallback} callback Node-style callback called with the error, if any, and Car
             * @returns {undefined}
             * @variation 1
             */
            Object.defineProperty(CarService.prototype.updataCar = function updataCar(request, callback) {
                return this.rpcCall(updataCar, $root.car.v1.UpdataCarRequest, $root.car.v1.Car, request, callback);
            }, "name", { value: "UpdataCar" });
