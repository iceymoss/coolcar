...
export const auth = $root.auth = (() => {
    ...
    auth.v1 = (function() {
        ...
        v1.LoginResponse = (function() {
             ...
             * @property {string|null} [accssToken] LoginResponse accssToken
            ...
            /**
             * LoginResponse accssToken.
             * @member {string} accssToken
             * @memberof auth.v1.LoginResponse
             * @instance
             */
            LoginResponse.prototype.accssToken = "";
            ...
            LoginResponse.fromObject = function fromObject(object) {
                ...
                if (object.accssToken != null)
                    message.accssToken = String(object.accssToken);
            ...
            LoginResponse.toObject = function toObject(message, options) {
                ...
                if (message.accssToken != null && message.hasOwnProperty("accssToken"))
                    object.accssToken = message.accssToken;
